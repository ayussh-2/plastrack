        ...
        <div class="section-container">
            <div class="text-center mb-12">
                ...
                <p class="text-muted-foreground max-w-2xl mx-auto">
                    Join a global network of changemakers and earn rewards for
                    your contributions.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div>
                    ...
                    <div
                        class="glass-card dark:glass-card-dark p-6 rounded-2xl mt-8"
                    >
                        <h4 class="font-medium mb-4">Recent Activity</h4>
                        <div class="space-y-4">
                            <div class="flex space-x-3">
                                <div
                                    class="w-1 bg-waste2way-teal rounded-full"
                                ></div>
                                <div>
                                    <p class="text-sm">
                                        You identified a new PET waste sample
                                    </p>
                            ...
                            <div class="flex space-x-3">
                                <div
                                    class="w-1 bg-waste2way-blue rounded-full"
                                ></div>
                                <div>
                                    <p class="text-sm">
                                        You reached level 5 in waste
                                        identification
                                    </p>
                                    <p class="text-xs text-muted-foreground">
                            ...
                            <div class="flex space-x-3">
                                <div
                                    class="w-1 bg-waste2way-coral rounded-full"
                                ></div>
                                <div>
                                    <p class="text-sm">
                                        You reported a waste hotspot in your
                                        area
                                    </p>
                                    <p class="text-xs text-muted-foreground">
