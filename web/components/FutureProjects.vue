        ...
        <div class="section-container">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                ...
                >
                    ...
                    <div class="mt-6 flex space-x-4">
                        ...
                        <button class="btn-secondary">
                            Impact Report
                            <TrendingUp class="ml-2 h-4 w-4 inline" />
                        </button>
                    </div>
                </div>
                ...
                <div class="order-1 md:order-2">
                    <div
                        class="relative rounded-2xl overflow-hidden h-80 shadow-xl"
                    >
                        <img
            ...
            <div class="mt-16 glass-card dark:glass-card-dark p-6 rounded-2xl">
                ...
                <div
                    class="relative rounded-xl overflow-hidden h-64 bg-slate-100"
                >
                    <!-- Map would be implemented here with an actual mapping library -->
                    <div
                    ...
                    <div
                        class="absolute top-2/3 right-1/3 w-12 h-12 rounded-full bg-yellow-500/30 animate-pulse-light"
                    >
                        <div
                            class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full w-4 h-4 bg-yellow-500"
                        >
                            <MapPin
                                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white"
                                size="8"
                    ...
                    <div
                        class="absolute top-1/3 right-1/4 w-10 h-10 rounded-full bg-green-500/30 animate-pulse-light"
                    >
                        <div
                            class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full w-3 h-3 bg-green-500"
                        >
                            <MapPin
                                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white"
                                size="6"
