...
export const trashController = {
  ...
  createMultipleReports: asyncHandler(async (req: Request, res: Response) => {
    ...
    return handleSuccess(res, reports, "Module reports created successfully");
  }),
  ...
  getTrashReports: asyncHandler(async (req: Request, res: Response) => {
    ...
    return handleSuccess(res, reports, "Trash reports retrieved successfully");
  }),
  ...
  createTrashFeedback: asyncHandler(async (req: Request, res: Response) => {
    ...
    const response = await trashService.createTrashFeedback(reportId, feedback);
  ...
  getTrashFeedbackForArea: asyncHandler(async (req: Request, res: Response) => {
